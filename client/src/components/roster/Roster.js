...
function Roster() {
  ...
  return (
    <div className="align">
      ...
      {crud === 0 ? <div><p className="header"><b>Create Roster Entry</b></p><RosterCreate /></div>
        : crud === 1 ? <div><p className="header"><b>Update Roster Entry</b></p><RosterUpdate /></div>
        : <div><p className="header"><b>Destroy Roster Entry</b></p><RosterDestroy /></div>
      }
    </div>
  );
}
