...
INSERT INTO `personnel` VALUES (1,'Piotr','Ocano','M','Vulcan','Starfleet'),(2,'Yukon','Paulsen','M','Vulcan','Hirogen'),(3,'Nicol','Locke','F','Klingon','Klingon'),(4,'Damien','Zephyr','M','Human','Starfleet'),(5,'Piers','Ducote','F','Human','Starfleet');
...
INSERT INTO `starship_data` VALUES ('111','Baby','Infantry'),('222','Buzzkill','Infantry'),('333','Meteor','Demolition'),('444','Severance','Medical'),('555','Hope','Medical');
...
INSERT INTO `starship_operator` VALUES ('111',3,40101.7,40111.8),('222',4,41277.9,41301.2),('333',5,41156.0,41182.6),('555',2,41306.9,41307.6);
...
INSERT INTO `starship_owner` VALUES ('111',1,40100.5,40111.8),('222',2,41277.9,41306.1),('333',3,41181.5,41182.6),('444',1,40111.8,NULL);
...
-- Dump completed on 2023-07-31 23:25:53
